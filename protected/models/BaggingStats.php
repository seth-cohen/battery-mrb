...
/**
 * This is the model class for table "tbl_bagging_stats".
 *
 * The followings are the available columns in table 'tbl_bagging_stats':
 * @property string $id
 * @property string $electrode_id
 * @property string $bagging_date
 * @property integer $reject_count
 * @property integer $good_count
 * @property string $bagger_id
 *
 * The followings are the available model relations:
 * @property User $bagger
 * @property Electrode $electrode
 */
class BaggingStats extends CActiveRecord
{
	public $bagger_search;
	/**
	 * @return string the associated database table name
	 */
	public function tableName()
	{
		return 'tbl_bagging_stats';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('reject_count, good_count, electrode_id, bagger_id, bagging_date', 'required'),
			array('electrode_id, bagger_id', 'length', 'max'=>10),
			array('bagging_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, electrode_id, bagging_date, reject_count, good_count', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bagger' => array(self::BELONGS_TO, 'User', 'bagger_id'),
	...
	public function search()
	{
		...
		$criteria->compare('bagging_date',$this->bagging_date,true);
	 ...
	 * @return BaggingStats the static model class
	 */
	 ...
	 */
	function saveBaggingStats($statsModels)
	{
		$error = 0;
		$models = array();
