<div class=" link-list" id="testlab-link-list" style="width:47%; float:left;">
	...
	<ul>
		...
		<li><?php echo CHtml::link('Miscellaneous Testing', array('testlab/misctesting'));?></li>
		<li><?php echo CHtml::link('View Miscellaneous Tests', array('testlab/miscindex'));?></li>
		<li><?php echo CHtml::link('Test Reassignments', array('testlab/testreassignment'));?></li>
		<li><?php echo CHtml::link('View All Tests (Historic)', array('testlab/testindex'));?></li>
	</ul>
