...
class ChannelController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','dynamicChannels'),
				'users'=>array('*'),
			),
	...
	/**
	 * Fills dropdownlist with value/name tags based off of the selected cycler
	 * 
	 */
	public function actionDynamicchannels()
	{
		$data=Channel::model()->findAll('cycler_id=:cycler_id',
						array(':cycler_id'=>$_POST['cycler_id']));
	...
	public function actionAjaxSetStatus()
	{
		...
		if(isset($_POST['status']))
		{
			...
			if($model->save())
			{
				...
				$message->subject = 'ALERT: Channel marked as '.$commissionStatus  ;
